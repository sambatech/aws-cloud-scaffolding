...
resource "kubectl_manifest" "metrics_server_cluster_a" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "metrics_server_cluster_b" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "metrics_server_cluster_role_binding_a" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
...
resource "kubectl_manifest" "metrics_server_cluster_role_binding_b" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
