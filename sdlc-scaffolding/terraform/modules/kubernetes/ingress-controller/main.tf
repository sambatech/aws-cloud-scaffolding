...
resource "kubectl_manifest" "cert_manager_custom_resource_definition_0" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_custom_resource_definition_1" {
    yaml_body = <<YAML
# Source: cert-manager/templates/crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "cert_manager_custom_resource_definition_2" {
    yaml_body = <<YAML
# Source: cert-manager/templates/crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "cert_manager_custom_resource_definition_3" {
    yaml_body = <<YAML
# Source: cert-manager/templates/crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "cert_manager_custom_resource_definition_4" {
    yaml_body = <<YAML
# Source: cert-manager/templates/crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "cert_manager_custom_resource_definition_5" {
    yaml_body = <<YAML
# Source: cert-manager/templates/crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "cert_manager_service_account_0" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_service_account_1" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_service_account_2" {
    yaml_body = <<YAML
apiVersion: v1
kind: ServiceAccount
automountServiceAccountToken: true
...
resource "kubectl_manifest" "cert_manager_config_map" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_cluster_role_0" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_cluster_role_1" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_cluster_role_2" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
...
resource "kubectl_manifest" "cert_manager_cluster_role_3" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
...
resource "kubectl_manifest" "cert_manager_cluster_role_4" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
...
resource "kubectl_manifest" "cert_manager_cluster_role_5" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
...
resource "kubectl_manifest" "cert_manager_cluster_role_6" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
...
resource "kubectl_manifest" "cert_manager_cluster_role_7" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
...
resource "kubectl_manifest" "cert_manager_cluster_role_8" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
...
resource "kubectl_manifest" "cert_manager_cluster_role_9" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
...
resource "kubectl_manifest" "cert_manager_cluster_role_10" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
# Permission to:
...
resource "kubectl_manifest" "cert_manager_cluster_role_11" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_0" {
    yaml_body = <<YAML
# Source: cert-manager/templates/cainjector-rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_1" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_2" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_3" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_4" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_5" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_6" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_7" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_8" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_cluster_role_binding_9" {
    yaml_body = <<YAML
# Source: cert-manager/templates/webhook-rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
...
resource "kubectl_manifest" "cert_manager_role_0" {
    yaml_body = <<YAML
# Source: cert-manager/templates/cainjector-rbac.yaml
...
resource "kubectl_manifest" "cert_manager_role_1" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: Role
...
resource "kubectl_manifest" "cert_manager_role_2" {
    yaml_body = <<YAML
# Source: cert-manager/templates/webhook-rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: Role
...
resource "kubectl_manifest" "cert_manager_role_binding_0" {
    yaml_body = <<YAML
# Source: cert-manager/templates/cainjector-rbac.yaml
...
resource "kubectl_manifest" "cert_manager_role_binding_1" {
    yaml_body = <<YAML
# Source: cert-manager/templates/rbac.yaml
# grant cert-manager permission to manage the leaderelection configmap in the
# leader election namespace
...
resource "kubectl_manifest" "cert_manager_role_binding_2" {
    yaml_body = <<YAML
# Source: cert-manager/templates/webhook-rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
...
resource "kubectl_manifest" "cert_manager_service_0" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_service_1" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_deployment_0" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_deployment_1" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_deployment_2" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_mutating_webhook_configuration" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "cert_manager_validating_webhook_configuration" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "ingress_controller_custom_resource_definition_0" {
    yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "ingress_controller_custom_resource_definition_1" {
    yaml_body = <<YAML
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
...
resource "kubectl_manifest" "ingress_controller_cluster_role" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRole
metadata:
...
resource "kubectl_manifest" "ingress_controller_role_binding" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
...
resource "kubectl_manifest" "ingress_controller_cluster_role_binding" {
    yaml_body = <<YAML
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
...
resource "kubectl_manifest" "ingress_controller_deployment" {
    yaml_body = <<YAML
apiVersion: apps/v1
kind: Deployment
metadata:
...
resource "kubectl_manifest" "ingress_controller_certificate" {
    yaml_body = <<YAML
...
resource "kubectl_manifest" "ingress_controller_issuer" {
    yaml_body = <<YAML
apiVersion: cert-manager.io/v1
kind: Issuer
metadata:
...
resource "kubectl_manifest" "ingress_controller_mutating_webhook_configuration" {
    yaml_body = <<YAML
apiVersion: admissionregistration.k8s.io/v1
kind: MutatingWebhookConfiguration
metadata:
...
resource "kubectl_manifest" "ingress_controller_validating_webhook_configuration" {
    yaml_body = <<YAML
apiVersion: admissionregistration.k8s.io/v1
kind: ValidatingWebhookConfiguration
metadata:
