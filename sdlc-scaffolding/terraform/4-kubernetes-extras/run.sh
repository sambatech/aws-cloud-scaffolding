...
terraform -chdir="${SCRIPT_DIR}/terraform" plan -compact-warnings -var-file="${PARENT_DIR}/0-envs/platform.tfvars" -out="${SCRIPT_DIR}/terraform/kubernetes-extra.tfplan"
